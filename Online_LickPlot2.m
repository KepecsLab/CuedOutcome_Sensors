function figData=Online_LickPlot2(action,trialSequence,figData,outcome,licks)
...
hold off
set(trialsubplot,'XLim',[3-plotSpan 3+plotSpan],'YLim',[0.5 5.5],'YDir','reverse','YTick',1:5);
